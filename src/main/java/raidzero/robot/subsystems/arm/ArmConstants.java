...
public class ArmConstants {
    ...
    public static class Wrist {
        ...
        public static final double SENSOR_TO_MECHANISM_RATIO = 71.0 / 24.0 * 25.0;
        ...
        public static final double EXPO_V = 1.0;
        public static final double EXPO_A = 1.0;

        public static final AngularVelocity CRUISE_VELOCITY = RotationsPerSecond.of(2.0);
        public static final AngularAcceleration ACCELERATION = RotationsPerSecondPerSecond.of(2.0);
    ...
    public static class Positions {
        ...
        public static final ArmPose HOME = Arm.calculateArmPose(HOME_X, HOME_Y, HOME_THETA1_UP, HOME_WRIST_ANGLE);
        ...
        public static final ArmPose L4 = Arm.calculateArmPose(L4_X, L4_Y, L4_THETA1_UP, L4_WRIST_ANGLE);
        ...
        public static final ArmPose L3 = Arm.calculateArmPose(L3_X, L3_Y ,L3_THETA1_UP, L3_WRIST_ANGLE );
        ...
        public static final ArmPose L2 = Arm.calculateArmPose(L2_X, L2_Y, L2_THETA1_UP, L2_WRIST_ANGLE);
        ...
        public static final ArmPose L1 = Arm.calculateArmPose(L1_X, L1_Y, L1_THETA1_UP, L1_WRIST_ANGLE);
        ...
        public static final ArmPose STATION = Arm.calculateArmPose(STATION_X, STATION_Y, STATION_THETA1_UP, STATION_WRIST_ANGLE);
        ...
        public static final ArmPose GROUND_INTAKE = Arm.calculateArmPose(
            GROUND_INTAKE_X, GROUND_INTAKE_Y, GROUND_INTAKE_THETA1_UP, GROUND_INTAKE_WRIST_ANGLE
        );
        ...
        public static final ArmPose L3_ALGAE = Arm.calculateArmPose(L3_ALGAE_X, L3_ALGAE_Y, L3_ALGAE_THETA1_UP, L3_ALGAE_WRIST_ANGLE);
        ...
        public static final ArmPose L2_ALGAE = Arm.calculateArmPose(L2_ALGAE_X, L2_ALGAE_Y, L2_ALGAE_THETA1_UP, L2_ALGAE_WRIST_ANGLE);
        ...
        public static final ArmPose BARGE = Arm.calculateArmPose(BARGE_X, BARGE_Y, BARGE_THETA1_UP, BARGE_WRIST_ANGLE);
        ...
        public static final ArmPose PROCESSOR = Arm.calculateArmPose(PROCESSOR_X, PROCESSOR_Y, PROCESSOR_THETA1_UP, PROCESSOR_WRIST_ANGLE);
    ...
    public static class ArmPose {
        Pose2d pose;
        Angle proximal, distal, relativeWrist, absoluteWrist;
        List<ArmPose> interpolationPath = null;

        public ArmPose(Angle proximal, Angle distal, Angle relativeWrist, Distance X, Distance Y, Angle absoluteWrist) {
            this.proximal = proximal;
            this.distal = distal;
            this.relativeWrist = relativeWrist;
            this.pose = new Pose2d(X, Y, Rotation2d.kZero);
            this.absoluteWrist = absoluteWrist;
        }

        public ArmPose withInterPolationPath(ArmPose... poses) {
